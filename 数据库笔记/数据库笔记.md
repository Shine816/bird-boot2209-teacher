...
- 教每门课程的老师的平均工资是多少?
  ...
  ![image-20221122093734975](image-20221122093734975.png)
...
- 仅查看平均工资高于6000的那些课程的老师平均工资
  ...
  ![image-20221122103144436](image-20221122103144436.png)
...
- 查看与"祝雷"和"李费水"在同一个班的学生都有谁?
  ...
  ![image-20221122140622584](image-20221122140622584.png)
...
- 查看类名老师的名字和其任课的科目名称?
  ...
  ![image-20221122152919328](image-20221122152919328.png)

  ![image-20221122153611217](image-20221122153611217.png)

- 不指定连接条件时，可以通过结果集看出teacher表的每条记录都与subject表每条记录关联了一次产生一条结果(产生了笛卡尔积，记录数是teacher表的20条与subject表的5条的乘积，共100条记录！！！)

  ![image-20221122154048440](image-20221122154048440.png)
...
- 查看"范传奇"所带班级的学生都有谁?要列出:学生名字，年龄，班级名称，老师名字
  ...
  ![image-20221122171121318](image-20221122171121318.png)
